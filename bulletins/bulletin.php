...
-->
        <div class="edit-info">
            <div class="profile-pic">
                <img class="pfp-fallback" src="/pfp/<?= $userInfo['pfp'] ?>"
            ...
            <div class="author-details">
                <h4>
                    ...
                    <span itemprop="author" itemscope itemtype="http://schema.org/Person">
                        <meta itemprop="url" content="https://<?= DOMAIN_NAME ?>/profile.php?id=<?= $bulletin['author'] ?>">
                        <span itemprop="name">
                            <a href="/user?id=<?= $bulletin['author'] ?>">
            ...
            <div class="inner">
                ...
                <p>
                    <b>
                        ...
                        ( <a href="comments.php?id=<?= $bulletin['id'] ?>">View all</a> | <a href="comments.php?id=<?= $bulletin['id'] ?>">Add Comment</a>
                        )
                    </b>
                </p>
